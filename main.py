...
# python main.py --al_runs KMeans1 --AL_START KMeans --run_times 1 --cfg_file config/config_AL2000_randomsplit_BLCATEST.yml& 
# python main.py --al_runs KMeans2 --AL_START KMeans --run_times 2 --cfg_file config/config_AL2000_randomsplit_BLCATEST.yml& 
# python main.py --al_runs KMeans3 --AL_START KMeans --run_times 3 --cfg_file config/config_AL2000_randomsplit_BLCATEST.yml& 
# python main.py --al_runs KMeans4 --AL_START KMeans --run_times 4 --cfg_file config/config_AL2000_randomsplit_BLCATEST.yml& 
# python main.py --al_runs KMeans5 --AL_START KMeans --run_times 5 --cfg_file config/config_AL2000_randomsplit_BLCATEST.yml& 

# python main.py --al_runs cluster_Knn_uncertainty1 --AL_START cluster_Knn_uncertainty --run_times 1 --cfg_file config/config_AL2000_randomsplit_BLCATEST.yml& 
# python main.py --al_runs cluster_Knn_uncertainty2 --AL_START cluster_Knn_uncertainty --run_times 2 --cfg_file config/config_AL2000_randomsplit_BLCATEST.yml& 
# python main.py --al_runs cluster_Knn_uncertainty3 --AL_START cluster_Knn_uncertainty --run_times 3 --cfg_file config/config_AL2000_randomsplit_BLCATEST.yml& 
# python main.py --al_runs cluster_Knn_uncertainty4 --AL_START cluster_Knn_uncertainty --run_times 4 --cfg_file config/config_AL2000_randomsplit_BLCATEST.yml& 
# python main.py --al_runs cluster_Knn_uncertainty5 --AL_START cluster_Knn_uncertainty --run_times 5 --cfg_file config/config_AL2000_randomsplit_BLCATEST.yml& 



# python main.py --al_runs uniform1 --AL_START uniform --run_times 1 --cfg_file config/config_AL2000_randomsplit_BLCATEST.yml& 
# python main.py --al_runs uniform2 --AL_START uniform --run_times 2 --cfg_file config/config_AL2000_randomsplit_BLCATEST.yml& 
# python main.py --al_runs uniform3 --AL_START uniform --run_times 3 --cfg_file config/config_AL2000_randomsplit_BLCATEST.yml& 
# python main.py --al_runs uniform4 --AL_START uniform --run_times 4 --cfg_file config/config_AL2000_randomsplit_BLCATEST.yml& 
# python main.py --al_runs uniform5 --AL_START uniform --run_times 5 --cfg_file config/config_AL2000_randomsplit_BLCATEST.yml& 

# python main.py --al_runs margin1 --AL_START margin --run_times 1 --cfg_file config/config_AL2000_randomsplit_BLCATEST.yml& 
# python main.py --al_runs margin2 --AL_START margin --run_times 2 --cfg_file config/config_AL2000_randomsplit_BLCATEST.yml& 
# python main.py --al_runs margin3 --AL_START margin --run_times 3 --cfg_file config/config_AL2000_randomsplit_BLCATEST.yml& 
# python main.py --al_runs margin4 --AL_START margin --run_times 4 --cfg_file config/config_AL2000_randomsplit_BLCATEST.yml& 
# python main.py --al_runs margin5 --AL_START margin --run_times 5 --cfg_file config/config_AL2000_randomsplit_BLCATEST.yml& 

# python main.py --al_runs contrastive_active_learning1 --AL_START contrastive_active_learning --run_times 1 --cfg_file config/config_AL2000_randomsplit_BLCATEST.yml& 
# python main.py --al_runs contrastive_active_learning2 --AL_START contrastive_active_learning --run_times 2 --cfg_file config/config_AL2000_randomsplit_BLCATEST.yml& 
# python main.py --al_runs contrastive_active_learning3 --AL_START contrastive_active_learning --run_times 3 --cfg_file config/config_AL2000_randomsplit_BLCATEST.yml& 
# python main.py --al_runs contrastive_active_learning4 --AL_START contrastive_active_learning --run_times 4 --cfg_file config/config_AL2000_randomsplit_BLCATEST.yml& 
# python main.py --al_runs contrastive_active_learning5 --AL_START contrastive_active_learning --run_times 5 --cfg_file config/config_AL2000_randomsplit_BLCATEST.yml& 
...
def main():
    ...
    parser.add_argument('--cfg_file', type=str, help="Experiment configuration file", default="config/config_GDSC2crossdomain.yml")
    # parser.add_argument('--cfg_file', type=str, help="Experiment configuration file", default="config/config_KPGT.yml")
    parser.add_argument('--al_runs', type=str, default="KMeans4")
    parser.add_argument('--AL_START', type=str, default="KMeans")
    parser.add_argument('--device', type=str, default="cuda:0")
    parser.add_argument('--run_times', type=str, default="4")
    ...
    if os.path.exists(source_path): 
        ...
        '''
            ...
            #     writer = csv.writer(file)
            #     writer.writerow([f"{0}", f"{test_AUC:.5f}", f"{test_PRC:.5f}", f"{test_Accuracy:.5f}", f"{test_Precision:.5f}", f"{test_Sensitivity:.5f}", f"{test_Specificity:.5f}", f"{test_F1:.5f}", f"{test_Recall:.5f}"])    
            ...
            for ix in tqdm_rat: # 主动学习迭代的轮次，采样数量循环
                ...
                if ix == 0 and not args.AL.Cold_start:
                    ...
                    # 使用第一轮随机采样作为启动数据
                        ...
                        # np.random.seed(42)  #  固定第一轮随机挑选的样本，保证公平
